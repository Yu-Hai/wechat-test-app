...
public class XmlUtil
{
    ...
    {
        String textFromFile =
            FileUtils.readFileToString(new File("C:/Users/Administrator/Desktop/books.xml"),
                "UTF-8");
     ...
     * @throws IOException
     */
    public static Document map2xml(Map<String, Object> map, String rootName) throws DocumentException,
        IOException
    {
